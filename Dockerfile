...
RUN apt-get update && apt-get -y install git curl apache2 php7.0 libapache2-mod-php7.0 php7.0-mysql php7.0-sqlite php7.0-mcrypt nodejs php7.0-xml php7.0-zip unzip php7.0-mbstring php7.0-json supervisor npm && apt-get -y autoremove && apt-get clean && rm -rf /var/lib/apt/lists/*
